...
# CUDA_VISIBLE_DEVICES=3 python main.py --dataset_path ./NIPS_test/ -arch resnet50 --activation relu --device cuda --csv_results_dir rs -iter 1
CUDA_VISIBLE_DEVICES=3 python main.py --dataset_path ./NIPS_test/ -arch free_ssim_eps2 --activation relu --device cuda --csv_results_dir rs -iter 3
CUDA_VISIBLE_DEVICES=3 python main.py --dataset_path ./NIPS_test/ -arch free_ssim_eps2 --activation relu --device cuda --csv_results_dir rs -iter 5
CUDA_VISIBLE_DEVICES=3 python main.py --dataset_path ./NIPS_test/ -arch free_ssim_eps2 --activation relu --device cuda --csv_results_dir rs -iter 8
