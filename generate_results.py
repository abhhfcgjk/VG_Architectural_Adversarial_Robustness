...
for i, epsilon in enumerate(epsilons):
	...
	axs[i].set_ylim((-3,0))
	axs[i].grid(True)			
fig.legend(legends, ["clear_relu", "attacked_relu", "clear_silu", "attacked_silu"], 'lower center', ncol=3, bbox_to_anchor=(0, 1.01, 1, 0.1), fontsize=2+fontsize)
plt.tight_layout()
plt.savefig("eps_comp.pdf", bbox_inches="tight")