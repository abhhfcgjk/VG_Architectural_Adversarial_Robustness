...
def run(args):
    ...
    model = IQAModel('Linearity', arch=args.architecture, pool=args.pool, use_bn_end=args.use_bn_end, P6=args.P6, P7=args.P7).to(device)  #
...
if __name__ == "__main__":
    ...
    ckpt = os.path.join(destination_path, 'activation=relu-Linearity-apgd_ssim-bs=8-loss=norm-in-norm-p=1.0-q=2.0-detach-False-KonIQ-10k-res=True-498x664')

    parser.add_argument('--trained_model_file', default=ckpt, type=str,
