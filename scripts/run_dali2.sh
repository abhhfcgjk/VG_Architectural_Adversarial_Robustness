...
if [ "$fc" = "fc" ]
then
    mapfile -t args < /scratch/amoskalenko/users/28i_mel/vanDBCNN/options/fc_args2.txt
else
    mapfile -t args < /scratch/amoskalenko/users/28i_mel/vanDBCNN/options/nofc_args2.txt
fi
metric_name="DBCNN"
dir_name="."
